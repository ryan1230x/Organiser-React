...
export const GET_CLOSED_TICKETS_BY_NETWORK = "GET_CLOSED_TICKETS_BY_NETWORK";
...
export const GET_ALL_SNIPPETS_FOR_USER = "GET_ALL_SNIPPETS_FOR_USER";
export const ADD_SNIPPET_FOR_USER = "ADD_SNIPPET_FOR_USER";
